      ...
      <div className={`p-4 border-b border-gray-200 ${isCollapsed ? 'items-center' : ''}`}>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <div className="absolute bottom-0 right-0 w-3 h-3 bg-accent-500 rounded-full border-2 border-secondary bg-gradient-to-r from-purple-600 to-blue-500" />
          </div>
          ...
          <Link
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${
              location.pathname === item.path
                ? 'bg-accent-50 text-accent-600 icon'
