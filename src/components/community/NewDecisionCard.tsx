...
export function NewDecisionCard({ categories, editingDecision }: Props) {
    ...
    return (
        <>
            <div className="mb-5 px-4 text-center">
                ...
                <div className="inline-block w-full max-w-7xl mb-8 mt-1 p-6 text-left align-middle bg-secondary rounded-2xl shadow-md transform transition-all bg-white rounded-3xl shadow-[0_0_50px_-12px_rgb(0,0,0,0.12)] p-6 inset-0 bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl -m-6
                ">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {categories.map(category => (
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-full text-sm transition-colors ${selectedTags.includes(category)
